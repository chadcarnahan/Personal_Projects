...
ggplot(densityData, aes(x=suicides.100k.pop,fill=generation))+
...
# Suicide based on countries with happiness index, seperated into countries with 7.5 above/below then 6 above/below, went with 7.5 first to keep data balanced only represented 1/4 of data overall though. Neither categories showed any meaningful difference interestingly enough.
